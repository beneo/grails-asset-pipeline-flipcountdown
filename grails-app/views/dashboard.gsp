...
<head>
    ...
    <!-- Bootstrap framework -->
    <asset:stylesheet src="${assetPath(src: "bootstrap.min.css")}"/>
    <!-- jQuery UI theme -->
    <asset:stylesheet src="lib/jquery-ui/css/Aristo/Aristo.css"/>
    <!-- tooltips-->
    <asset:stylesheet src="lib/jBreadcrumbs/css/BreadCrumb.css"/>
    <!-- tooltips-->
    <asset:stylesheet src="lib/qtip2/jquery.qtip.min.css"/>
    <!-- colorbox -->
    <asset:stylesheet src="lib/colorbox/colorbox.css"/>
    <!-- code prettify -->
    <asset:stylesheet src="lib/google-code-prettify/prettify.css"/>
    <!-- sticky notifications -->
    <asset:stylesheet src="lib/sticky/sticky.css"/>
    <!-- aditional icons -->
    <asset:stylesheet src="splashy/splashy.css"/>
    <!-- flags -->
    <asset:stylesheet src="flags/flags.css"/>
    <!-- datatables -->
    <asset:stylesheet src="lib/datatables/extras/TableTools/media/css/TableTools.css"/>

    <!-- calendar -->
    <asset:stylesheet src="lib/fullcalendar/fullcalendar_gebo.css"/>

    <!-- main styles -->
    <asset:stylesheet src="css/style.css"/>
    <!-- theme color-->
    <asset:stylesheet src="css/blue.css" id="link_theme"/>

    <asset:stylesheet src='http://fonts.googleapis.com/css?family=PT+Sans' rel='stylesheet' type='text/css'/>
...
<asset:javascript src="js/jquery-migrate.min.js"/>
<asset:javascript src="lib/jquery-ui/jquery-ui-1.10.0.custom.min.js"/>
<!-- touch events for jquery ui-->
<asset:javascript src="js/forms/jquery.ui.touch-punch.min.js"/>
<!-- easing plugin -->
<asset:javascript src="js/jquery.easing.1.3.min.js"/>
<!-- smart resize event -->
<asset:javascript src="js/jquery.debouncedresize.min.js"/>
<!-- js cookie plugin -->
<asset:javascript src="js/jquery_cookie_min.js"/>
<!-- main bootstrap js -->
<asset:javascript src="bootstrap/js/bootstrap.min.js"/>
<!-- bootstrap plugins -->
<asset:javascript src="js/bootstrap.plugins.min.js"/>
<!-- typeahead -->
<asset:javascript src="lib/typeahead/typeahead.min.js"/>
<!-- code prettifier -->
<asset:javascript src="lib/google-code-prettify/prettify.min.js"/>
<!-- sticky messages -->
<asset:javascript src="lib/sticky/sticky.min.js"/>
<!-- tooltips -->
<asset:javascript src="lib/qtip2/jquery.qtip.min.js"/>
<!-- lightbox -->
<asset:javascript src="lib/colorbox/jquery.colorbox.min.js"/>
<!-- jBreadcrumbs -->
<asset:javascript src="lib/jBreadcrumbs/js/jquery.jBreadCrumb.1.1.min.js"/>
<!-- hidden elements width/height -->
<asset:javascript src="js/jquery.actual.min.js"/>
<!-- custom scrollbar -->
<asset:javascript src="lib/slimScroll/jquery.slimscroll.js"/>
<!-- fix for ios orientation change -->
<asset:javascript src="js/ios-orientationchange-fix.js"/>
<!-- to top -->
<asset:javascript src="lib/UItoTop/jquery.ui.totop.min.js"/>
<!-- mobile nav -->
<asset:javascript src="js/selectNav.js"/>

<!-- common functions -->
<asset:javascript src="js/gebo_common.js"/>

<!-- multi-column layout -->
<asset:javascript src="js/jquery.imagesloaded.min.js"/>
<asset:javascript src="js/jquery.wookmark.js"/>
<!-- responsive table -->
<asset:javascript src="js/jquery.mediaTable.min.js"/>
<!-- small charts -->
<asset:javascript src="js/jquery.peity.min.js"/>
<!-- charts -->
<asset:javascript src="lib/flot/jquery.flot.min.js"/>
<asset:javascript src="lib/flot/jquery.flot.resize.min.js"/>
<asset:javascript src="lib/flot/jquery.flot.pie.min.js"/>
<!-- calendar -->
<asset:javascript src="lib/fullcalendar/fullcalendar.min.js"/>
<!-- sortable/filterable list -->
<asset:javascript src="lib/list_js/list.min.js"/>
<asset:javascript src="lib/list_js/plugins/paging/list.paging.min.js"/>
<!-- dashboard functions -->
<asset:javascript src="js/gebo_dashboard.js"/>
